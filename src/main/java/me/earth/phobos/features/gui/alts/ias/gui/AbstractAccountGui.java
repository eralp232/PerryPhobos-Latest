...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.complete = new GuiButton(2, this.width / 2 - 152, this.height - 28, 150, 20, I18n.format((String)this.actionString, (Object[])new Object[0]));
        this.buttonList.add(this.complete);
        this.buttonList.add(new GuiButton(3, this.width / 2 + 2, this.height - 28, 150, 20, I18n.format((String)"gui.cancel", (Object[])new Object[0])));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.format((String)this.actionString, (Object[])new Object[0]), this.width / 2, 7, -1);
        this.drawCenteredString(this.fontRenderer, I18n.format((String)"ias.username", (Object[])new Object[0]), this.width / 2 - 130, 66, -1);
        this.drawCenteredString(this.fontRenderer, I18n.format((String)"ias.password", (Object[])new Object[0]), this.width / 2 - 130, 96, -1);
