        ...
        if (module != null) {
            if (commands.length == 1) {
                ...
                for (Setting setting : module.getSettings()) {
                    if (setting.equals(module.enabled) || setting.equals(module.drawn) || setting.equals(module.bind) || setting.equals(module.newBlock) || setting.equals(module.showBlocks)) continue;
