...
extends Module {
    ...
    public void onPacketSend(PacketEvent.Send event) {
        ...
        if (this.noFriendAttack.getValue().booleanValue() && event.getPacket() instanceof CPacketUseEntity && (entity = ((CPacketUseEntity)event.getPacket()).getEntityFromWorld((World)BlockTweaks.mc.world)) != null && Phobos.friendManager.isFriend(entity.getName())) {
