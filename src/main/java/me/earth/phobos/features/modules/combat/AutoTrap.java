...
extends Module {
    ...
    private boolean check() {
        ...
        if (this.disable.getValue().booleanValue() && this.startPos != null && !this.startPos.equals((Object)EntityUtil.getRoundedBlockPos((Entity)AutoTrap.mc.player))) {
            this.disable();
            return true;
        }
