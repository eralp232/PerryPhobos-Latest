    ...
    public void onUpdate() {
        if (this.mode.getValue() == Mode.BYPASS && this.devMode.getValue() == 1 && ElytraFlight.mc.player.isElytraFlying()) {
            ...
            if (forwardInput != 0.0 || strafeInput != 0.0) {
                ...
                ElytraFlight.mc.player.motionX = forward * (double)this.speed.getValue().floatValue() * cos + strafe * (double)this.speed.getValue().floatValue() * sin;
                ElytraFlight.mc.player.motionZ = forward * (double)this.speed.getValue().floatValue() * sin - strafe * (double)this.speed.getValue().floatValue() * cos;
            }
    ...
    public void onMove(MoveEvent event) {
        if (this.mode.getValue() == Mode.LOOK && ElytraFlight.mc.player.isElytraFlying()) {
            ...
            if (ElytraFlight.mc.player.movementInput.moveForward != 0.0f) {
                ElytraFlight.mc.player.motionY = (double)this.hSpeed.getValue().floatValue() * -((double)ElytraFlight.mc.player.movementInput.moveForward * Math.sin(MathUtil.degToRad(ElytraFlight.mc.player.rotationPitch)));
            }
            if (ElytraFlight.mc.player.movementInput.jump) {
                ElytraFlight.mc.player.motionY = this.vSpeed.getValue().floatValue();
            } else if (ElytraFlight.mc.player.movementInput.sneak) {
                ElytraFlight.mc.player.motionY = -1.0f * this.vSpeed.getValue().floatValue();
            }
            ...
            if (ElytraFlight.mc.player.movementInput.moveStrafe != 0.0f && ElytraFlight.mc.player.movementInput.moveForward == 0.0f) {
                ElytraFlight.mc.player.motionX = forward * (double)this.hSpeed.getValue().floatValue() * cos + strafe * (double)this.hSpeed.getValue().floatValue() * sin;
                ElytraFlight.mc.player.motionZ = forward * (double)this.hSpeed.getValue().floatValue() * sin - strafe * (double)this.hSpeed.getValue().floatValue() * cos;
            } else if (ElytraFlight.mc.player.movementInput.moveStrafe != 0.0f || ElytraFlight.mc.player.movementInput.moveForward != 0.0f) {
                ElytraFlight.mc.player.motionX = (forward * (double)this.hSpeed.getValue().floatValue() * cos + strafe * (double)this.hSpeed.getValue().floatValue() * sin) * Math.cos(Math.abs(MathUtil.degToRad(ElytraFlight.mc.player.rotationPitch)));
                ElytraFlight.mc.player.motionZ = (forward * (double)this.hSpeed.getValue().floatValue() * sin - strafe * (double)this.hSpeed.getValue().floatValue() * cos) * Math.cos(Math.abs(MathUtil.degToRad(ElytraFlight.mc.player.rotationPitch)));
            }
        ...
        switch (this.mode.getValue()) {
            case BOOST: {
                if (ElytraFlight.mc.player.isInWater()) {
                    Objects.requireNonNull(mc.getConnection()).sendPacket((Packet)new CPacketEntityAction((Entity)ElytraFlight.mc.player, CPacketEntityAction.Action.START_FALL_FLYING));
                    return;
                }
