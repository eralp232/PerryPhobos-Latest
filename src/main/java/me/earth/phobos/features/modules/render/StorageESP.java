...
//            BlockPos blockPos;
            ...
            if (!(StorageESP.mc.player.getDistanceSq(pos) <= MathUtil.square(this.range.getValue().floatValue())) || (color = this.getTileEntityColor(tileEntity)) == -1) continue;
...
//            BlockPos blockPos;
            ...
            if (!(StorageESP.mc.player.getDistanceSq(pos) <= MathUtil.square(this.range.getValue().floatValue())) || (color = this.getEntityColor(entity)) == -1) continue;
            positions.put(pos, color);
        }
